...
class DataHelper:
    def __init__(self, gz=True, config=None, k=''):
    ...
    def get_feature_file(self, tag):   
        return join(self.data_dir, tag + '_feature' +self.k+ self.suffix)

    def get_example_file(self, tag):
        return join(self.data_dir, tag + '_example' +self.k+ self.suffix)
